...
import cs544.exercise13_2.bank.config.AppConfiguration;
import cs544.exercise13_2.bank.domain.Account;
import cs544.exercise13_2.bank.domain.AccountEntry;
import cs544.exercise13_2.bank.domain.Calculator;
...
public class App {
    ...
    public static void main(String[] args) {
        ...
        IAccountService accountService = context.getBean(IAccountService.class);//  new AccountService();
