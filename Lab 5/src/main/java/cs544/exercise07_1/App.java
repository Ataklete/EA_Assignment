...
public class App {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            List<Flight> flights = session.createQuery("select f from Flight f join f.origin o join f.airplane ap where o.country='USA' "
        ...
        try {
            ...
            // TODO update HQL
            @SuppressWarnings("unchecked")
            List<Airline> airlines = session.createQuery("select distinct a from Airline a join a.flights f "
                    + "where f.airplane.model='A380'").list();
        ...
        try {
            ...
            // TODO update HQL
            @SuppressWarnings("unchecked")
            List<Flight> flights = session.createQuery(" select f from Flight f where f.departureDate = '2009-08-07'" + " and departureTime < '12:00:00'").list();
